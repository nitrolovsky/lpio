@component('components.offer')
    @slot('title')
        Аэрогимнастика в Санкт-Петербурге
    @endslot
    ...
    @slot('description')
        Студии аэрогимнастики в Санкт-Петербурге
    @endslot
    ...
    @slot('offer')
        Получите промокод на бесплатное пробное занятие по аэрогимнастики и узнайте как развить здоровое тело за 30 дней
    @endslot

    @slot('details')
        Забронируем вам место в мастер-группе на ближайшую свободную дату
    @endslot
    ...
    @slot('legal')
        Copyright &#169; 2017 &laquo;YoSpace&raquo;<br>
