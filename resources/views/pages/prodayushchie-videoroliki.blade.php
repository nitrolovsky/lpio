@component('components.landing-page-bullet')
    ...
    @slot('bg_image')
        /files/prodayushchie-videoroliki/prodayushchie-videoroliki.jpg
    @endslot
    ...
    @slot('description')
        Создание продающих видеороликов для бизнеса в Санкт-Петербурге  
    @endslot
    ...
    @slot('offer')
        Получите презентацию "Как снять возражения ДОРОГО ваших клиентов с помощью продающих видеороликов"
    @endslot

    @slot('details')
        Заполните поля email и телефон на которые мы отправим презентацию
    @endslot
    ...
    @slot('legal')
        prodayushchie-videoroliki.lpio.ru
    @endslot
