@component('components.onescreen')
    ...
    @slot('offer')
        Художественная роспись стен частных и коммерческих интерьеров от 1500р/м2. Cначала рисуем. Оплата после выполненной работы
    @endslot
    ...
    @slot('bullets')
        ...
        <li class="pt-1">
            Выполняем срочные заказы вовремя
        </li>
    @endslot
