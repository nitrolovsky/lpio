@component('components.landing-page-bullet')
    ...
    @slot('offer')
        Получите бесплатный дизайн-проект и расчет стоиммости удобной гардеробной
    @endslot

    @slot('details')
        3D визуализация позволит понять как будет выглядить ваша гардеробная и на сколько она будет удобная
    @endslot
