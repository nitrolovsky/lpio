@component('components.bullet')
    ...
    @slot('offer')
        Роспись стен интерьеров и фасадов от 750 р./м2. Cначала рисуем. Оплата после выполненной работы
    @endslot
    ...
    @slot('leadmagnet')
        Получите расчет стоимости 3 вариантов проекта и визуализацию бесплатно, заполнив форму
    @endslot
