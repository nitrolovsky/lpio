...
<html>
    ...
    <body>
        ...
        @component('components.firstscreen')
            ...
            @endslot
            @slot('offer')
                Товарный бетон с доставкой напрямую от заводов ООО "ЛБЗ"
            @endslot
            @slot('bullets')
                <li>
                    Гарантируем соблюдение технических характеристик по ГОСТу
                </li>
                <li class="pt-1">
                    Для частных и жилых домов, коммерческих и промышленных объектов
                </li>
                <li class="pt-1">
                    Бесплатный выезд специалиста для расчета точного объема
                </li>
            @endslot
            @slot('video')
