@component('components.landing-page-bullet')
    ...
    @slot('bg_image')
        /files/metallokonstrukcii/metallokonstrukcii.jpg
    @endslot
    ...
    @slot('offer')
        Получите бесплатный подробный сметный расчет на металлоконструкцию
    @endslot

    @slot('details')
        Детальное техническое задание. 3D визуализация. Согласование с экспертизой. Собственное производство. Допуски СРО.
    @endslot
