@component('components.landing-page-bullet')
    ...
    @slot('offer')
        Получите презентацию с примерами "Youtube канал видеоблог для привлечения клиентов и продаж"
    @endslot

    @slot('details')
        Вы узнаете на примерах как продавать больше с помощью видеоблога. В чем отличие одноразового видоролика о компании от видеоблога. Как видеоблог увеличивает доверие и повторные продажи.
    @endslot
