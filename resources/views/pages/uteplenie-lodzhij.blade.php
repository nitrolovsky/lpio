@component('components.landing-page-bullet')
    ...
    @slot('bg_image')
        /files/uteplenie-lodzhij/uteplenie-lodzhij.jpg
    @endslot
    ...
    @slot('description')
        Утепление лоджий и балконов в Петербурге
    @endslot
    ...
    @slot('offer')
        Получите дизайн-проект отделки лоджии и расчет стоимост работ по утеплению
    @endslot

    @slot('details')
        Подробный расчет сметы с указанием материалов и цен. Подробное объяснение проекта утепления
    @endslot
