@component('components.landing-page-bullet')
    ...
    @slot('bg_image')
        /files/razrabotka-veb-servisov/razrabotka-veb-servisov.jpg
    @endslot
    ...
    @slot('offer')
        Получите консультацию "Как упростить обработку данных в excel"
    @endslot

    @slot('details')
        Если вы работаете с данными в excel. 
    @endslot
