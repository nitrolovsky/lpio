@component('components.offer')
    ...
    @slot('offer')
        Получите инструкцию "Как избежать лишних трат при ремонте и отделке с помощью дизайн-проекта и сохранить от 300 тысяч рублей".
    @endslot

    @slot('details')
        Время чтения - 9 минут. На основе опыта более 130 заказчиков. Сохранено в общей сумме более 16 миллионов рублей и 27 месяцев работы на переделки.
    @endslot
