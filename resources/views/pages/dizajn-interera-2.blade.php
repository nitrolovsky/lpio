@component('components.offer')
    ...
    @slot('offer')
        Пройдите тест из 10 вопросов и узнайте стоимость дизайн-проекта интерьера, который идеально вам подходит
    @endslot

    @slot('details')
        На основе опыта общения с более тысячей заказчиков дизайн-проектов интерьера различных стилей. Время прохождения теста - 2 минуты.
    @endslot
