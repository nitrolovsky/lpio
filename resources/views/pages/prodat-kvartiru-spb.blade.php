@php
    $name = 'prodat-kvartiru-spb';
    $image_path = "/files/prodat-kvartiru-spb/prodat-kvartiru-spb";
@endphp
@component('components.lp20180129')
    @slot('title')
        Агентство недвижимости Купина, продадим вашу квартиру в Санкт-Петербурге {{ $name }}.lpio.ru
    @endslot
    ...
    @slot('details')
        <ul class="mb-0">
            <li>
                Профессиональные фотографии увеличивает скорость и вероятность покупки;
            </li>
            <li>
                У нас уже есть покупатели, которые возможно ищут вашу квартиру;
            </li>
            <li>
    ...
    @slot('popup_form_title')
        Введите телефон, чтобы мы перезвонили и договорились о дате и времени встречи
    @endslot
