@component('components.landing-page-bullet')
    ...
    @slot('bg_image')
        /files/kontraktnye-dvigateli/kontraktnye-dvigateli.jpg
    @endslot
    ...
    @slot('description')
        Контрактные двигатели по России
    @endslot
    ...
    @slot('offer')
        Подберем контрактный двигатели б/у для вашего авто с низким пробегом
    @endslot

    @slot('details')
        Перед поставкой двигатели проходят техническое испытание и даем на них гарантию 3 года.
    @endslot
