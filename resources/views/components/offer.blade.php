                ...
                <div class="container font">
                    ...
                    <div class="row py-5">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 text-xl-right text-lg-right text-md-right text-sm-center text-center w-4">
                            ...
                            <a href="tel:{{ $phone or '' }}" class="text-info h1 w-4 a">{{ $phone_view or '' }}</a><br>
                    ...
                    <div class="row pb-5">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 col-10 offset-xl-4 offset-lg-4 offset-md-3 offset-sm-2 offset-1">
                            {{ $form or '' }}
                        </div>
                    </div>

                    <div class="row py-5 text-center">
                        <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 offset-xl-4">
                            {{ $legal or '' }}
                        </div>
                    </div>
